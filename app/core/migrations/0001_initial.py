...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dni', models.CharField(blank=True, max_length=13, null=True, unique=True, validators=[proy_sales.utils.valida_ruc], verbose_name='RUC')),
                ...
                ('latitude', models.CharField(default='0.0', max_length=100, verbose_name='Latitud')),
                ('longitude', models.CharField(default='0.0', max_length=100, verbose_name='Longitud')),
                ('representative', models.CharField(blank=True, max_length=50, null=True, verbose_name='Responsable')),
                ('landline', models.CharField(blank=True, max_length=14, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Formato correcto: (0X) XXXX-XXXX, donde 0X es el código de área.', regex='^\\(0[2-7]\\) \\d{4}-\\d{4}$')], verbose_name='Teléfono Fijo')),
                ('website', models.URLField(blank=True, max_length=100, null=True, unique=True, validators=[django.core.validators.URLValidator], verbose_name='Sitio Web')),
                ...
                ('establishment_code', models.CharField(blank=True, default=proy_sales.utils.generate_establishment_code, help_text='Código de tres dígitos asignado al establecimiento por el SRI. Para empresas sin sucursales, usar "001".', max_length=3, null=True, unique=True, verbose_name='Código de Establecimiento')),
                ...
                ('authorization_number', models.CharField(blank=True, default=proy_sales.utils.generate_random_authorization_number, help_text='Número de autorización otorgado por el SRI.', max_length=49, null=True, verbose_name='Número de Autorización')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dni', models.CharField(blank=True, max_length=10, null=True, unique=True, validators=[proy_sales.utils.valida_cedula], verbose_name='Dni')),
                ...
                ('date_of_birth', models.DateField(blank=True, null=True, validators=[proy_sales.utils.validate_date_of_birth], verbose_name='Fecha Nacimiento')),
                ('phone', models.CharField(blank=True, max_length=50, null=True, unique=True, validators=[django.core.validators.RegexValidator(message="El número de teléfono debe contener entre 9 y 15 dígitos, con un código de país opcional en formato '+XXX '.", regex='^(\\+\\d{1,3}\\s?)?\\d{9,12}$')], verbose_name='Telefono')),
                ('email', models.CharField(blank=True, max_length=100, null=True, unique=True, validators=[django.core.validators.EmailValidator], verbose_name='Correo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(decimal_places=2, max_digits=6, unique=True, verbose_name='Porcentaje(%)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(max_length=100, unique=True, verbose_name='Metodo de Pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.DecimalField(decimal_places=2, default=Decimal('0.0'), max_digits=10, validators=[proy_sales.utils.valida_numero_flotante_positivo], verbose_name='Costo Producto')),
                ...
                ('expiration_date', models.DateTimeField(default=datetime.datetime(2024, 8, 21, 0, 17, 37, 753020, tzinfo=datetime.timezone.utc), validators=[proy_sales.utils.validate_expiration_date], verbose_name='Caducidad')),
                ('image', models.ImageField(blank=True, null=True, upload_to='products/', verbose_name='Imagen')),
                ('state', models.CharField(choices=[('A', 'En Percha'), ('B', 'De Baja')], default='A', max_length=1, verbose_name='Estado')),
                ('created', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True, verbose_name='Activo')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateTimeField(db_index=True, validators=[proy_sales.utils.get_current_datetime], verbose_name='Fecha Emision')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message="El número de teléfono debe contener entre 9 y 15 dígitos, con un código de país opcional en formato '+XXX '.", regex='^(\\+\\d{1,3}\\s?)?\\d{9,12}$')], verbose_name='Telefono')),
