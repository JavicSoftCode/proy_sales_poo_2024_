...
class Brand(models.Model):
  ...
  def get_image(self):
    if self.image:
      ...
      return '/static/img/incognito.png'
...
class Product(models.Model):
  ...
  state = models.CharField(verbose_name='Estado', max_length=1, choices=(('A', 'En Percha'), ('B', 'De Baja')),
                           default='A')
  created = models.DateTimeField(default=timezone.now, editable=False)
  updated = models.DateTimeField(auto_now=True)
  active = models.BooleanField(verbose_name='Activo', default=True)
...
class ProductPriceDetail(models.Model):
  productpreci = models.ForeignKey(ProductPrice, on_delete=models.PROTECT, related_name='productPrice_detail',
                                   verbose_name='Producto Precio detalle')
  product = models.ForeignKey(Product, on_delete=models.PROTECT, related_name='price_detail',
                              verbose_name='Producto Precio detalle')
