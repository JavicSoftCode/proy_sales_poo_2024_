...
class Invoice(models.Model):
  customer = models.ForeignKey(Customer, on_delete=models.PROTECT, related_name='invoice_customers',
                               verbose_name='Cliente')
  payment_method = models.ForeignKey(PaymentMethod, on_delete=models.CASCADE, related_name='invoices_payment',
...
class InvoiceDetail(models.Model):
  ...
  product = models.ForeignKey(Product, on_delete=models.PROTECT, related_name='InvoiceDetail_products',
